...
static struct this_s this = {
  ...
  // Adjusted for 70g drone (vs 27g Crazyflie 2.0)
  // thrustBase: hover thrust for 70g drone (~2.6x heavier)
  // Note: These values should be tuned during flight testing
  .thrustBase = 38000,  // Approximate hover thrust for 70g drone (tune during flight)
  .thrustMin  = 8000,   // Minimum thrust to keep motors spinning (tune during flight)
};
#endif
