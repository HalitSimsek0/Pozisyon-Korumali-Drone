...
void wifiInit(void)
{
    ...
    // EKLE: Captive portal için DNS server'ı AP'nin IP adresine ayarla
    // Bu, mobil cihazlarda captive portal algılamasını iyileştirir
    esp_netif_dns_info_t dns_info;
    dns_info.ip.u_addr.ip4.addr = ipaddr_addr("192.168.43.42");  // AP IP'si DNS server olarak
